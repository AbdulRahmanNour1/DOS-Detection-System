...
WINDOW = 1.0               # sec per bucket
HIST = 120                 # keep last N windows for baseline
MIN_BASELINE = 20          # start up threshold
...
        ("udp_rate", udp_rate), ("icmp_req_rate", icmp_req_rate),
...
    # summary
    summary = (f"pps={pps:.0f} bps={bps/1e6:.2f}Mbps syn={state['tcp_syn']} "
               f"udp={state['udp_pkts']} icmp_req={state['icmp_echo_req']} "
